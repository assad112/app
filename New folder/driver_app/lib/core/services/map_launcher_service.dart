  ...
  List<Uri> _buildCandidates({
    ...
    if (destination != null) {
      ...
      if (!kIsWeb && defaultTargetPlatform == TargetPlatform.iOS) {
        final appleParams = origin != null
            ? '?saddr=${origin.latitude},${origin.longitude}&daddr=${destination.latitude},${destination.longitude}&dirflg=d'
            : '?daddr=${destination.latitude},${destination.longitude}&dirflg=d';
        candidates.add(Uri.parse('http://maps.apple.com/$appleParams'));
      }
