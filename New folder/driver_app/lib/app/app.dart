...
import 'package:driver_app/shared/widgets/new_order_overlay.dart';
...
class _MainShellScreenState extends ConsumerState<MainShellScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pendingOrder = ref.watch(newOrderNotifierProvider);
    ...
    return Stack(
      children: [
        ...
        // New order overlay — appears on top of everything
