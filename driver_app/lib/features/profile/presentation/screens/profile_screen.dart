...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final _dashboardData = switch (dashboardState) {
      AsyncData(:final value) => value,
      _ => null,
    };
    final completedValue =
        _dashboardData?.totalCompleted.toString() ?? '0';
    final activeValue =
        _dashboardData?.activeDeliveries.toString() ?? '0';
    final earningsValue = Formatters.currency(
      _dashboardData?.todayEarnings ?? 0,
