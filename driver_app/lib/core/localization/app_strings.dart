...
class AppStrings {
  ...
  String get appName => isArabic ? 'سائق ogas' : 'ogas Driver';
  ...
  String get splitOrderBadge =>
      isArabic ? 'جزء من طلب رئيسي' : 'Part of main order';
  String get multiItemSummary =>
      isArabic ? 'تفاصيل الأسطوانات' : 'Cylinder details';
  String get childOrderHint => isArabic
      ? 'أنت ترى فقط الجزء المخصص لك من هذا الطلب.'
      : 'You are viewing only the part assigned to you from this order.';
  String get parentOrderReference =>
      isArabic ? 'الطلب الرئيسي' : 'Main order';
  String get inventoryGroup =>
      isArabic ? 'فئة المخزون' : 'Inventory group';
  String get noStructuredItems =>
      isArabic ? 'لا توجد عناصر مفصلة بعد' : 'No structured items yet';
