                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (order.hasStructuredItems || order.isSplitChild) ...[
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: [
                              ...
                              if (order.hasStructuredItems)
                                _MetaBadge(
                                  ...
                                  label:
                                      '${strings.multiItemSummary}: ${order.items.length}',
                          ...
                          children: [
                            ...
                            Expanded(
                              child: _InfoItem(
                                ...
                                label:
                                    '${strings.quantity} ${order.totalRequestedQuantity}',
